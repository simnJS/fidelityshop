    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">
            Bienvenue sur la politique de confidentialité de FidelityShop. Cette politique explique comment nous collectons, utilisons, stockons et protégeons vos données personnelles lorsque vous utilisez notre site.
          </p>
          <p className="mb-3">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-3">
            <li>Informations d'inscription : nom d'utilisateur, adresse e-mail, mot de passe (hashé)</li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-3">Nous utilisons les types de cookies suivants :</p>
          <ul className="list-disc pl-6 mb-3">
